...
# Define your classes
classes = ['crack', 'irregular', 'prorosity', 'sagging', 'scratch']  # Add your own class names

# Path to the directory containing XML files
xml_dir = r'C:\Users\Lenovo\PycharmProjects\ultralytics-main\data/NEU-DET/train/annatation'
output_dir = r'C:\Users\Lenovo\PycharmProjects\ultralytics-main\data/NEU-DET/train/labels'  # Output directory for YOLO format files

test_xml_dir = r'C:\Users\Lenovo\PycharmProjects\ultralytics-main\data/NEU-DET/test/annatation'
test_output_dir = r'C:\Users\Lenovo\PycharmProjects\ultralytics-main\data/NEU-DET/test/labels'  # Output directory for YOLO format files
